...
# 列出所有 SceneSolution 中的所有节点
  ...
  cmdlet.exe resourcesScan -sceneSolutions -quests -mode=sectionTracksClips -output=D:\Q115result.json -scanBasePath=base\quest\main_quests\part1\q115\scenes

    cmdlet.exe resourcesScan -sceneSolutions -quests -mode=sectionTracksClips -output=D:\QEmpthresult.json -scanBasePath=base\quest\main_quests\part1\q115\scenes

        cmdlet.exe resourcesScan -sceneSolutions -quests -mode=sectionTracksClips -output=D:\QEmpthresult.json -scanBasePath=base\quest\testgym